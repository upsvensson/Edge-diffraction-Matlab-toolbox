% EDdebug2 runs EDmain_convexESIEBEM for several defined tests, to check its handling of
            ...
            for ll = 1:length(diffordervar)
                ...
                for mm = 1:length(addsouvar)
                    ...
                    for nn = 1:length(souamp)
                        ...
                        EDmain_convexESIEBEM(geoinputdata,Sinputdata,Rinputdata,struct,controlparameters,filehandlingparameters);
