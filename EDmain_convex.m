...
if controlparameters.docalcir == 1
        EDsettingsdatastruct = struct('geoinputdata_corners',geoinputdata.corners,...
            'Sindata_coordinates',Snewdata.coordinates,...
            'Sindata_sourceamplitudes',Snewdata.sourceamplitudes,...
            'Rindata_coordinates',Rnewdata.coordinates,...
...
if controlparameters.difforder > 1
    ...
    [edgetoedgedata,elapsedtimeed2geo,existingfilename] = EDed2geo(edgedata,planedata,Snewdata,...
        Rnewdata,1,2,EDversionnumber,2,1,filehandlingparameters);
...
if controlparameters.difforder > 1 && ( controlparameters.docalctf == 1 || controlparameters.docalctf_ESIEBEM == 1)
    ...
    [tfinteqdiff,timingdata,extraoutputdata,elapsedtimehodtf,existingfilename] = ...
    	...
    	Snewdata,Rnewdata,envdata,controlparameters,EDversionnumber,filehandlingparameters,EDsettingshash);
