...
if controlparameters.docalcir == 1
        EDsettingsdatastruct = struct('geoinputdata_corners',geoinputdata.corners,...
            'Sindata_coordinates',Sinputdata.coordinates,...
            'Sindata_sourceamplitudes',Sinputdata.sourceamplitudes,...
            'Rindata_coordinates',Rinputdata.coordinates,...
        ...
        EDsettingshash = DataHash(EDsettingsdatastruct);
end
...
if controlparameters.skipfirstorder == 0
    ...
    EDfindconvexGApaths(planedata,edgedata,...
...
if ( controlparameters.docalctf == 1 || controlparameters.docalctf_ESIEBEM == 1)...
    ...
    [tfdirect,tfgeom,tfdiff,timingdata,elapsedtimemaketfs,existingfilename] ...
        ...
        edgedata,EDversionnumber,filehandlingparameters,geoinputdata,EDsettingshash);
...
if controlparameters.docalcir == 1 && controlparameters.skipfirstorder == 0
    ...
    [irdirect,irgeom,irdiff,timingdata,elapsedtimemakeirs,existingfilename] ...
        = EDmakefirstorderirs(firstorderpathdata,controlparameters.fs,...
        controlparameters.Rstart,controlparameters.difforder,envdata,...
        Sinputdata,Rdata.receivers,edgedata,controlparameters.saveindividualfirstdiff,...
...
if controlparameters.difforder > 1
    ...
    [edgetoedgedata,elapsedtimeed2geo,existingfilename] = EDed2geo(edgedata,planedata,Sdata,...
        Rdata,1,2,EDversionnumber,2,1,filehandlingparameters);
...
if controlparameters.difforder > 1 && ( controlparameters.docalctf == 1 || controlparameters.docalctf_ESIEBEM == 1)
    ...
    [Hsubmatrixdata,elapsedtimesubmatrix,existingfilename] = ...
        EDinteg_submatrixstructure(edgedata.edgelengthvec,edgedata.closwedangvec,...
        controlparameters.ngauss,controlparameters.discretizationtype,...
        edgetoedgedata,edgedata.planesatedge,EDversionnumber,filehandlingparameters);
...
if controlparameters.difforder > 1 && ( controlparameters.docalctf == 1 || controlparameters.docalctf_ESIEBEM == 1)
    ...
    [tfinteqdiff,timingdata,extraoutputdata,elapsedtimehodtf,existingfilename] = ...
        EDintegralequation_convex_tf(filehandlingparameters,...
        envdata,planedata,edgedata,edgetoedgedata,Hsubmatrixdata,Sdata,Sinputdata.doaddsources,Sinputdata.sourceamplitudes,...
        Sinputdata.doallSRcombinations,Rdata,controlparameters,EDversionnumber,EDsettingshash);
...
if controlparameters.docalctf_ESIEBEM == 1
    ...
    [tftot_ESIEBEM,elapsedtimeESIEBEMpropagate,existingfilename] = ...
        ...
        Rinputdata,fieldpoints,Sinputdata,directsound_fieldpoints,...
        controlparameters,envdata,EDversionnumber,filehandlingparameters,EDsettingshash);
...
if controlparameters.docalcir == 1 && controlparameters.difforder > 1
    ...
    [hodpaths,hodpathsalongplane,elapsedtimehodpaths,existingfilename] ...
        ...
        sign(Sdata.vispartedgesfroms),sign(Rdata.vispartedgesfromr),...
...
if controlparameters.difforder > 1 && controlparameters.docalcir == 1
   ...
   [irhod,elapsedtimemakeirhod,existingfilename] = EDmakeHODirs(hodpaths,hodpathsalongplane,controlparameters.difforder,elemsize,edgedata,...
        ...
        filehandlingparameters.showtext,EDversionnumber,filehandlingparameters,EDsettingshash);
