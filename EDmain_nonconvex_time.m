function EDmain_nonconvex_time(geoinputdata,Sinputdata,Rinputdata,envdata,controlparameters,filehandlingparameters)
% EDmain_nonconvex_time - Calculates the specular and edge diffraction IRs 
