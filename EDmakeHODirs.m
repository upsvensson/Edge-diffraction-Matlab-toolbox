        ...
        for ii = 1:ncomponents
            ...
            if Ndifforder >= 2
                ...
                if any(lastndivcomb~=newndivvec)
                    if Ndifforder == 2
                        ivmatrix = EDB1creindexmatrix(newndivvec);
                    else
                        ivmatrix = EDB1creindexmatrix(newndivvec(2:end));                        
                    end
            ...
            if Ndifforder == 2
                ...
                [irnew,~] = EDB1wedge2nd(cylS,cylR,cylE2_r1frac,cylE1_r2frac,...
...
%                 IRDIFFVEC = [IRDIFFVEC;sum(irnew)];
            ...
            elseif Ndifforder == 3    %   if Ndifforder == 2			
                ...
                for kk = 1:newndivvec(1)                    
                    ...
                    [irnewpartition,~] = EDB1wedgeN(cylS,cylR,wedgeparams,ncylrows,...
