...
= EDmakefirstorderirs(firstorderpathdata,geoinputdata,edgedata,Sdata,...
...
%   EDsettingshash, which is stored in the _ir matfile. 
%
% Output parameters:
...
% EDmakefirstorderirs(firstorderpathdata,geoinputdata,edgedata,Sdata,...
% Rdata,envdata,controlparameters,EDversionnumber,filehandlingparameters,EDsettingshash);
