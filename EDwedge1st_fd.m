...
% % % %         y = ESIE2betaoverml(x,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
% % % %         
% % % %         Q = [0 0 0];
% % % %         Q(:,1) = ESIE2quadstep(x(:,1),x(:,3),y(:,1),y(:,2),y(:,3),tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
% % % %         Q(:,2) = ESIE2quadstep(x(:,3),x(:,5),y(:,3),y(:,4),y(:,5),tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
% % % %         Q(:,3) = ESIE2quadstep(x(:,5),x(:,7),y(:,5),y(:,6),y(:,7),tol,rs,rr,zs,zr,ny,sinnyfivec,cosnyfivec);
