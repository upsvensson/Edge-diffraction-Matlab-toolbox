...
% The function EDmakegeo_shoebox centers the box around the origin, with the % front baffle at z = 0 but we
% shift it in the y−direction so that the origin (where the source will be) % has 0.2m to all edges.
