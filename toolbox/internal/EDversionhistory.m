...
icounter = icounter + 1;
versionnumbers{icounter} = '0.220';
versiondate{icounter} = '28 Oct. 2022';
versiontext{icounter} = ['Fixed a bug in EDfindconvexGApaths.m '...
    'The previous version missed direct sound obstacles.'];

icounter = icounter + 1;
versionnumbers{icounter} = '0.221';
versiondate{icounter} = '27 Sep. 2023';
versiontext{icounter} = ['Introduced the functions EDmessage.m '...
    'and EDpostfunctext.m to mae the main functions more readable.'];

icounter = icounter + 1;
versionnumbers{icounter} = '0.300';
versiondate{icounter} = '29 Sep. 2023';
versiontext{icounter} = ['Made a single EDmain_convex '...
    'and modified many functions to "version 2" which makes the '...
    'main function much more readable. The IR calc has not yet been '...
    'implemented in the EDmain_convex.'];

icounter = icounter + 1;
versionnumbers{icounter} = '0.301';
versiondate{icounter} = '3 Oct. 2023';
versiontext{icounter} = ['Implemented the IR calc in the single EDmain_convex. '...
    'Also added the results as an optional output parameter to EDmain_convex. '...
    'Also added a settings hash "EDsettingshash" which is saved in all '...
    'results files.'];
